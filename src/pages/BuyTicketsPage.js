...
const BuyTicketsPage = () => {
  ...
  // ✅ UPDATED: BOTH FETCHES USE dyp-tedx-backend-server.onrender.com
    ...
    try {
      ...
      if (data.success) {
        window.location.href = `/success?name=${encodeURIComponent(
          ...
          formData.phone
        )}&amount=${selectedSession.price}&ticketId=${data.ticketId}`;
      } else {
  ...
  return (
    <PageTemplate
      title="Register for TEDx Event"
      subtitle="Choose your session and join us for an inspiring experience"
    >
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-tedx-red"
              />
              <input
                type="email"
                name="email"
              ...
              {selectedSession && (
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-tedx-red">
